...
//DATA Pins
#define LCD_D0_PIN	GPIO_PINS_0
#define LCD_D1_PIN	GPIO_PINS_1
#define LCD_D2_PIN	GPIO_PINS_2
#define LCD_D3_PIN	GPIO_PINS_3
#define LCD_D4_PIN	GPIO_PINS_4
#define LCD_D5_PIN	GPIO_PINS_5
#define LCD_D6_PIN	GPIO_PINS_6
#define LCD_D7_PIN	GPIO_PINS_7
 
//Control Pins
#define RS_Switch			GPIO_PINS_8
#define RW_Switch			GPIO_PINS_9
#define Enable_Switch 		GPIO_PINS_10
